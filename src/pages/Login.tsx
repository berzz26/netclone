    ...
    <div className="min-h-screen flex flex-col bg-netflix-black">
      ...
      <main className="relative z-10 flex flex-grow items-center justify-center px-4 py-8">
        <div className="w-full max-w-md p-8 bg-black bg-opacity-80 rounded">
          ...
          <div className="mt-4 flex justify-between items-center">
            <div className="flex items-center">
              <input
                type="checkbox"
                id="remember"
                className="h-4 w-4 bg-gray-700 border-none rounded"
              />
          ...
          {/* Demo Credentials */}
          <div className="mt-6 p-3 bg-gray-900 rounded border border-gray-800">
            ...
            <p className="text-sm text-gray-400">Password: password</p>
          </div>
        </div>
      </main>
    </div>
